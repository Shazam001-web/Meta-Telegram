...
argument_parser = argparse.ArgumentParser(description='A tool for reporting telegram channels by t.me/shazamhacker', add_help=False)
...
if command_line_args.help:
  ...
  -h, --help ~> {Fore.YELLOW}show help{Fore.RESET}''')
    ...
    print(f"""
    _____    _ __    t.me/{Fore.MAGENTA} DevShazam{Fore.RESET}    💀
...
{Fore.YELLOW}-----------------------------------------------{Fore.RESET}
 a tool for reporting telegram channels by @shazamhacker
